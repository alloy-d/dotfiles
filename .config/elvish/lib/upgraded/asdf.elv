# WARNING: this is from asdf 0.9.0, run through the Elvish 0.17
# migration script.  Hopefully later versions of asdf will be compatible
# with 0.17, and we can do away with this.
use re
use str
use path
